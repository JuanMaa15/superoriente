...
if (isset($_POST['id'])) {
    ...
    if (preg_match('/[0-9]+/',$id_zapato)) {
        ...
        $cont = "<div class='row my-2'>"
                ...
                ."<input type='text' class='form-control' value='" . $zapatodto->getCantidad() . "' id='campo-cant' readonly>"
                ."<input type='text' class='d-none form-control' value='" . $zapatodto->getCantidad() . "' id='campo-cant-fija' readonly>"
                ."</div>"
                ."</div>"
            ."<div class='row my-4'>";
