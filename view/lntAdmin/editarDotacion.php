            ...
            <div class="col-10 mt-4 ps-0 py-5 position-relative" id="cuerpo-pagina">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row justify-content-end">
                            <div class="col-4">
                                <select class="form-select" id="filtro-camisa" class="filtro-camisa-editar">
                            ...
                            <div class="col-6">
                                <form>
                                    <input type="search"  class="form-control buscador-camisa-editar" id="buscador-camisa" placeholder="Buscar">
                                </form>
                            </div>
                        </div>
                        <div id="listado-camisas-editar">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-12">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-6">
                                <form>
                                    <input type="search"  class="form-control buscador-pantalon-editar" id="buscador-pantalon" placeholder="Buscar">
                                </form>
                            </div>
                        </div>
                        <div id="listado-pantalones-editar">
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                         <div class="row justify-content-end">
                            ...
                            <div class="col-6">
                                <form>
                                    <input type="search"  class="form-control buscador-zapato-editar" id="buscador-zapato" placeholder="Buscar">
                                </form>
                            </div>
                        </div>
                        <div id="listado-zapatos-editar">
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-6">
                                <form>
                                    <input type="search"  class="form-control buscador-vestimenta-editar" id="buscador-vestimenta" placeholder="Buscar">
                                </form>
                            </div>
                        </div>
                        <div id="listado-vestimentas-editar">
                        </div>
                    </div>
                </div>
